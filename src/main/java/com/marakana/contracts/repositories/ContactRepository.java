...
public class ContactRepository {
	...
	public void init() throws SQLException {
		...
		try {
			...
			try {
				statement
						.execute("create table contact (id integer generated by default as identity primary key, name varchar(255), address_id integer, foreign key (address_id) reference address)");
			} finally {
				statement.close();
			}
		} finally {
